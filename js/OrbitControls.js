...
THREE.OrbitControls = function(galaxy) {

	this.galaxy = galaxy;
	this.object = this.galaxy.camera;
	this.domElement = (this.galaxy.renderer.domElement !== undefined ) ? this.galaxy.renderer.domElement : document;
		...
		*/
		...
		if(state != STATE.ZOOM && state != STATE.NONE){
			if (this.galaxy.cameraAttention === undefined){
				...
				this.object.lookAt(this.galaxy.cameraAttention);
			}
		}
		*/
	...
	function onDoubleClick(event) {
		...
		scope.galaxy.onDoubleClick(event);
