...
( function ( THREE ) {
	...
	THREE.GalaxyRaycaster = function ( galaxy, vector, near, far ) {
	...
	var intersectObject = function ( object, raycaster, intersects ) {
		...
		if(object.getMesh != undefined && object.getMesh() instanceof THREE.Mesh){
	...
	THREE.GalaxyRaycaster.prototype.precision = 0.0001;
	THREE.GalaxyRaycaster.prototype.linePrecision = 1;
	...
	THREE.GalaxyRaycaster.prototype.intersectObject = function ( object, recursive ) {
	...
	THREE.GalaxyRaycaster.prototype.intersectObjects = function ( objects, recursive ) {
	...
	THREE.GalaxyRaycaster.prototype.intersectGalaxy = function ( recursive ) {

		var intersects = [];
		
		var objects = this.galaxy.clickable;
